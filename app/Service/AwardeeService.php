...
class AwardeeService implements AwardeeServiceInterface
{
    ...
    public function __construct(AwardeeRepositoryInterface $awardeeRepository, Api $popsApi)
    {
    ...
    public function current_billing(object $payload)
    {
        ...
        if ($connection === "Success." && $serverStatus === 'Up') {
            ...
            //get monthly rental and monthy extension
            // $stall_profile = $this->awardeeRepository->current_billing($payload);
            // Log::debug($payload);
            ...
            $itemsPaid = [];
            // $itemsTest = [];
            $payload->duedate = $this->awardeeRepository->OPDueDate();
